  ...
  return (
    <section id="actions" className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="font-inter text-3xl sm:text-4xl font-bold mb-2 text-center text-foreground">BARK Actions</h2>
        ...
        <p className="font-poppins text-base sm:text-lg text-muted-foreground mb-12 text-center max-w-3xl mx-auto">
          Explore the diverse range of actions you can take with BARK. From minting and staking to governance and analytics, unlock the full potential of the BARK Protocol.
        </p>
